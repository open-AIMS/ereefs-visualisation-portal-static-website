...
::: {.table .table-hover}
+-----------------------+-----------------------+-----------------------+
| Island                | Freshwater exposure   | Reef flat mortality   |
|                       |                       | (%)                   |
|                       | (*PSU days*, 28 PSU   |                       |
|                       | threshold)            |                       |
+=======================+=======================+=======================+
...
::: {.mediaframe_wikipedia_imgframeblk style="max-width: 600px;"}
+-----------------------+-----------------------+-----------------------+
| Island                | Freshwater exposure   | Reef flat mortality   |
|                       |                       | (%)                   |
|                       | (*PSU days*, 28 PSU   |                       |
...
::: {.description}
Freshwater exposure calculated from measurements taken on the Keppel
Islands during the 2011 flooding. (Berkelmans et al. 2012)
:::
:::
:::
...
the error and confidence in the results. Figure 1 shows a comparison
...
::: {.media-image .mediaframe_wikipedia .wysiwyg-media-file}
::: {.image}
![Freshwater exposure eReefs model
comparison](../../images/GBR1-GBR4-freshwater-exposure-comparison_map_2019-02-800x643.png){.media-image
width="800" height="643"}
:::

::: {.metadata style="width: 800px; "}
[Freshwater exposure eReefs model comparison]{.title}

::: {.description}
Figure 1. This shows a comparison between the freshwater exposure
...
BY](../../images/cc.png){.cc
width="15" height="15"}
by AIMS](http://creativecommons.org/licenses/by/3.0/au/)]{.license}
:::
:::
...
<table class="column-page table" cellspacing="1" cellpadding="1" border="1" align="center">
	<tbody>
		<tr class="table-secondary">
			<td colspan="1" rowspan="2">Location</td>
			<td colspan="2" rowspan="1"><strong>1 km model</strong> (28 PSU threshold)</td>
			<td colspan="2" rowspan="1"><strong>4 km model</strong> (28 PSU threshold)</td>
			<td colspan="1" rowspan="2">Observed freshwater mortality</td>
		</tr>
		<tr class="table-secondary">
			<td>Freshwater exposure (PSU days)</td>
			<td>Predicted morality (Berkelmans, 2012)</td>
			<td>4 km model freshwater exposure (28 PSU threshold)</td>
			<td>Predicted morality (Berkelmans, 2012)</td>
		</tr>
		<tr>
			<td>Magnetic Island</td>
			<td>35</td>
			<td style="background-color: #66CC33;">None</td>
			<td>0</td>
			<td style="background-color: #66CC33;">None</td>
			<td style="background-color: #66CC33;">None</td>
		</tr>
		<tr>
			<td>Cape Ferguson</td>
			<td>75</td>
			<td style="background-color: #FF3333;">High</td>
			<td>15</td>
			<td style="background-color: #66CC33;">None</td>
			<td style="background-color: #FF3333;">High</td>
		</tr>
