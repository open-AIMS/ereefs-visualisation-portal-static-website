...
This page shows an estimate of exposure to fresh water on the Great
...
understood. However flooding from Fitzroy river in 2011 caused
...
This is quite similar to the freshwater exposure except that it includes
...
km model shows freshwater exposure of 35 PSU days, whereas the 4 km
model shows 0 PSU days.

![Freshwater exposure eReefs model comparison<br>[![CC BY SA](../../images/cc.png){.cc width="15" height="15"}](https://creativecommons.org/licenses/by-sa/3.0/au/) by [AIMS](//eatlas.org.au/node/2)](../../images/GBR1-GBR4-freshwater-exposure-comparison_map_2019-02-800x643.png){#fig-fresh-water-comparison}
...
<table class="table table-hover">
	<thead>
		...
		<tr>
			...
			<th>Predicted mortality (Berkelmans, 2012)</th>
...
was the case, whereas the 4 km model predicts none. At Magnetic Island
...
model is a better match to observations.
