...
-   Providing [data services](https://thredds.ereefs.aims.gov.au/thredds/s3catalogue/aims-ereefs-public-prod/derived/ncaggregate/ereefs/catalog.html)
...
::: {.media-image .mediaframe_wikipedia .wysiwyg-media-file .column-page}
::: {.image}
![AIMS eReefs platform
overview](images/AIMS-eReefs-platform-overview.png){.media-image}
:::

::: {.metadata style="width: 1000px; "}
[AIMS eReefs platform overview]{.title}
...
SA](../../images/cc.png){.cc
width="15"
height="15"}](http://creativecommons.org/licenses/by-sa/3.0/au/) by
[AIMS](//eatlas.org.au/node/2)]{.license}
:::
:::
