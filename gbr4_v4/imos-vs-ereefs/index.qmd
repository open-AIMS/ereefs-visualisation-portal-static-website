---
title: "imos-vs-ereefs_v4"
aliases:
  - /ereefs-aims/gbr4_v4/imos-vs-ereefs
format:
  html:
    template: ../../custom_template.html
params:
  product-name: Comparing eReefs (GBR4 v4.0 temperature, current) to IMOS satellite temperature and ocean current
  block-name: imos-vs-ereefs_v4
  product-id: products__ncanimate__mixed__imos-vs-ereefs_v4-temperature
---
...
current data we use the [IMOS - OceanCurrent - Gridded sea level anomaly -
Near real time](https://catalogue-imos.aodn.org.au/geonetwork/srv/api/records/0c9eb39c-9cbe-4c6a-8a10-5867087e703a)
dataset and for the temperature the [IMOS - SRS - SST - L3S - Single
Sensor - 6 day - night time - Australia](https://catalogue-imos.aodn.org.au/geonetwork/srv/api/records/f9d6616a-f359-4418-979a-e7b89b5b9086)
dataset. The 6 day period was chosen to reduce the chances of data gaps because of cloud coverage.
...
dataset are detided (see the [metadata record](https://catalogue-imos.aodn.org.au/geonetwork/srv/api/records/0c9eb39c-9cbe-4c6a-8a10-5867087e703a)
