---
title: "gbr4_v4-hydro_temp-wind-salt-current"
aliases:
  - /ereefs-aims/gbr4_v4/temp-wind-salt-current
format:
  html:
    template: ../../custom_template.html
params:
  product-name: Temperature, wind, salinity and current (GBR4 v4.0)
  block-name: gbr4_v4-hydro_temp-wind-salt-current
  product-id: products__ncanimate__ereefs__gbr4_v4__temp-wind-salt-current
---
...
Barrier Reef based on the [4km eReefs Hydrodynamic model](https://research.csiro.au/ereefs/models/).
This visualisation product is
...
then it can cause corals to bleach. This can be seen during the summer months of
2016 and 2017.
...
water, resulting in significant surface temperature rise during the day,
creating a "heart-beat" pattern in the temperature in the video (see the
Temperature panel in the [March 2017](/gbr4_v4/temp-wind-salt-current#year=2017;month=3) video as an example). The
...
drift over reefal areas (see [Feb 2011 Burdekin region](/gbr4_v4/temp-wind-salt-current#year=2011;month=2;region=townsville-3)
...
travel much further than is predicted by looking at just the lowering of the
salinity.
...
dispersed as planktonic larvae by ocean currents that float from reef to reef.

## Interesting events

- Cyclones: [**Yasi** (Feb 2011)](/gbr4_v4/temp-wind-salt-current#year=2011;month=2), [**Ita** (April 2014)](/gbr4_v4/temp-wind-salt-current#year=2014;month=4), [**Nathan** (March 2015)](/gbr4_v4/temp-wind-salt-current#year=2015;month=3), [**Debbie** (March 2017)](/gbr4_v4/temp-wind-salt-current#year=2017;month=3),
- Coral bleaching from high temperature ([March 2016](/gbr4_v4/temp-wind-salt-current#year=2016;month=3), [March 2017](/gbr4_v4/temp-wind-salt-current#year=2017;month=3)),
- Flood plumes with low salinity ([Burdekin Jan 2011](/gbr4_v4/temp-wind-salt-current#year=2011;month=1;region=townsville-3), [Feb 2019](/gbr4_v4/temp-wind-salt-current#region=townsville-3;year=2019;month=2)). [Salinity at 3 depths](/gbr1/salt-multi-depth#region=townsville-3) showing detail in the low salinity areas < 32 PSU.
- Strong East Australian Current ([Nov 2015, monthly average current](/gbr4_v4/temp-wind-salt-current#frame=Monthly;year=2015;month=11))
- Clear bifurcation of the currents around Lizard island, north of Cairns ([Oct 2014](/gbr4_v4/temp-wind-salt-current#frame=Monthly;year=2014;month=10))

{{< include ../../includes/_source_data_gbr4_v4.qmd >}}

{{< include ../../includes/_data_coverage.qmd >}}
