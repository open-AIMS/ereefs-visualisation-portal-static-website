...
Salinity is a measure of the salitiness of the water. Fresh water outflow from
...
- Flood plumes with low salinity ([Burdekin Jan 2011](/gbr4/temp-wind-salt-current#year=2011;month=1;region=townsville-3), [Feb 2019](/gbr4/temp-wind-salt-current#region=townsville-3;year=2019;month=2)). [Salinity at 3 depths](/gbr4/temp-wind-salt-current#region=townsville-3) showing detail in the low salinity areas < 32 PSU.
