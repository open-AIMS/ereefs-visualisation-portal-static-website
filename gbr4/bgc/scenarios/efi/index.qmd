...
concentration for most places along the coast, with the highest impact achieved in the far north.
...
This variable represents the difference in total suspended solids in mg/l between the reduced loads
