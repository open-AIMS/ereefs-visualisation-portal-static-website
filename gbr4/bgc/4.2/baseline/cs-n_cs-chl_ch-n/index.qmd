---
title: "gbr4-bgc4p2-baseline_cs-n_cs-chl_ch-n"
format:
  html:
    template: ../../../../../custom_template.html
params:
  product-name: Coral symbiont (nitrogen & chlorophyll) & coral host nitrogen (GBR4 BGC v4.2 baseline)
  block-name: gbr4-bgc4p2-baseline_cs-n_cs-chl_ch-n
  product-id: products__ncanimate__ereefs__gbr4_bgc4p2_baseline__cs-n_cs-chl_ch-n
---
...
very slowly over time. The main effect that can be seen in these
...
As chlorophyll is the only pigment resolved in the coral symbiont, it
...
entire grid cell. Unlike other epibenthic variables, coral area is
...
model contains no other benthic filter-feeders, CH best represents the
