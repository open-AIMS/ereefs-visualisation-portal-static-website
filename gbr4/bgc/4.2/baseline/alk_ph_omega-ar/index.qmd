---
title: "gbr4-bgc4p2-baseline_alk_ph_omega-ar"
format:
  html:
    template: ../../../../../custom_template.html
params:
  product-name: Total alkalinity, pH and aragonite saturation state (GBR4 BGC v4.2 baseline)
  block-name: gbr4-bgc4p2-baseline_alk_ph_omega-ar
  product-id: products__ncanimate__ereefs__gbr4_bgc4p2_baseline__alk_ph_omega-ar
---
...
can impede calcification. While the CSIRO eReefs BioGeoChemical (BGC)
...
pH based on \[H^+^\] calculated from carbon chemistry equilibria at water
...
Mass, T., Giuffre, A.J., Sun, C.Y., Stifler, C.A., Frazier, M.J., Neder, M.,
