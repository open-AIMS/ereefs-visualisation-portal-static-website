---
title: "gbr4-bgc4p2-baseline_secchi_kd-490_epipar-sg"
format:
  html:
    template: ../../../../../custom_template.html
params:
  product-name: Secchi depth, vertical attenuation at 490nm & light intensity above seagrass (GBR4 BGC v4.2 baseline)
  block-name: gbr4-bgc4p2-baseline_secchi_kd-490_epipar-sg
  product-id: products__ncanimate__ereefs__gbr4_bgc4p2_baseline__secchi_kd-490_epipar-sg
---
...
the disk cannot be seen. The model estimates the optical properties of
...
As light passes through the water column its intensity decreases due to
a combination of absorption and scattering. The amount of light
decreases exponentially as a function of the depth. The amount of light
...
mixed. Stratification of coloured dissolved organic matter (CDOM) or
...
that corresponds to the light attenuation in the model depth layer at a
...
amount of modelled coloured dissolved organic matter (CDOM) and sediment
in the water column. Further details of the vertical attenuation are
