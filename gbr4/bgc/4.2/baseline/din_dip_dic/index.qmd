---
title: "gbr4-bgc4p2-baseline_din_dip_dic"
format:
  html:
    template: ../../../../../custom_template.html
params:
  product-name: Dissolved Inorganic (Carbon, Nitrogen & Phosphorus) (GBR4 BGC v4.2 baseline)
  block-name: gbr4-bgc4p2-baseline_din_dip_dic
  product-id: products__ncanimate__ereefs__gbr4_bgc4p2_baseline__din_dip_dic
---
...
Nitrogen is critical for plant and animal growth. It is needed for
...
Within the GBR lagoon the main source of DIN is from land runoff during
...
phytoplankton. As these plankton die their detritus slowly sinks and the
...
−0.77±1.63 mg N m−3 (Baird et al., 2020). This represents the difference
...
Inorganic Phosphorus (PIP) at a rate dependent on the level of oxygen. A
...
(bias ± RMSE) of -0.88 ± 2.17 mg P m−3 (Baird et al., 2020). This is an
...
In the water column, DIC is taken up by phytoplankton as part of
...
GBR shows a bias ± RMSE of DIC of -7.7 ± 34.2 mmol m−3 (Baird et al.,
2020).
