...
a more programmatic approach. More clients can be found on the
...
the use of OPeNDAP is slower and less responsive but it is a good way
...
3.  In the popup window
    ...
    10. The dimension \"k\" should have been added to the list below the
        ...
        on the selected model:
          ...
          : *Mapping of dimension k to depth value in metres*{.hover}
