...
- Cyclones: [**Yasi** (Feb 2011)](./gbr4/temp-wind-salt-current/index.qmd#year=2011;month=2), [**Ita** (April 2014)](./gbr4/temp-wind-salt-current/index.qmd#year=2014;month=4), [**Nathan** (March 2015)](./gbr4/temp-wind-salt-current/index.qmd#year=2015;month=3), [**Debbie** (March 2017)](./gbr4/temp-wind-salt-current/index.qmd#year=2017;month=3),
...
Reef, whereas the 4 km model covers much of the Coral Sea.
...
The [GBR4 BioGeoChemical (BGC) model](https://research.csiro.au/ereefs/models/models-about/models-biogeochemistry/) builds on the GBR4 hydrodynamic model by
...
curvilinear NetCDF format), the [AIMS Data Extraction tool](https://extraction.ereefs.aims.gov.au/) (time series
...
and location. An older analysis on the BGC version 2.0 ([Skerratt et al., 2018](https://doi.org/10.1016/j.jmarsys.2018.12.006))
...
results should be used in combination with secondary sources of information for
making recommendations.

::: {.ncanimate-products .column-screen-right}
::: {.ncanimate-product-tile}
### Water chemistry
![](/images/Blue_Soda_bubbles_macro-500x250.jpg){fig-alt="Bubbles suspended in water" fig-align="center"}
...
- [Particulate inorganic phosphorus & particulate inorganic phosphorus sediments](./gbr4/bgc/baseline/pip_pip-sed)
...
- [Dissolved inorganic nitrogen](./gbr4/bgc/scenarios/din)
...
<https://dx.doi.org/10.1016/j.jmarsys.2018.12.006>
